...
// Cleanup for tool/create_write_file_diagnostic.dart -- soft-deletes the
// script, the event binding, and the throwaway table.
//
//   flutter test tool/remove_write_file_diagnostic.dart
